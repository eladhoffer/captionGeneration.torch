...
local captions
imgs, captions = data.ValDB:cacheSeq(Key(100),numImages, imgs)
imgs = imgs:cuda()
...
local imgNum = 1
local modelConfig = torch.load('./Results/caption2/Net_18.t7')
...
recurrent:setState(torch.zeros(numImages,128):cuda())
